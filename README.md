...
# Changelog(変更履歴)
重要
2/27 Freenom 系 ccTLD のフィッシングドメイン件数が大幅に減少しているため削除　国際的な管理・規制側の強化のため多くのccTLD（≒国別TLD）を削除
...
- avast LINE opera Gmail などをおすすめソフトとして 紹介しているアフィリエイト記事(自社のソフトを紹介、もしくはステマ込み)※ 条件厳しめかつできる限り客観的に評価している。
- DMMの紹介文と画像コピペしてアフィリエイトリンク挿入しただけの記事(レビューになっていない中身のない記事。)
- 詐欺サイト(ショッピング系など)
